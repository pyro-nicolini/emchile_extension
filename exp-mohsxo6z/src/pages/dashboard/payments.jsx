...
export default function PaymentsPage() {
  const { data, loading, error, fetchAll, create, update, remove } = usePayments();
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
        <h1 style={{ color: '#0f172a', margin: 0 }}>Gestión de Payments</h1>
        <button 
      ...
      <Modal isOpen={modalOpen} onClose={() => setModalOpen(false)} title={editingItem ? 'Editar Payments' : 'Nuevo Payments'}>
