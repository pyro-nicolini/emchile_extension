...
const QuotationsContext = createContext(null);

export function QuotationsProvider({ children }) {
  ...
  const update = async (id, payload) => {
    try {
      const res = await QuotationsService.update(id, payload);
  ...
  return (
    <QuotationsContext.Provider value={{ data, loading, error, fetchAll, create, update, remove }}>
      {children}
